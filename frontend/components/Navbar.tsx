...
export default function Navbar() {
  ...
  useEffect(() => {
    ...
    // Escuchar cambios en localStorage (cuando se actualiza desde otra pestaña/componente)
    ...
    // También escuchar eventos personalizados para actualizaciones locales
